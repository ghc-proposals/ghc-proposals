---
author: Artyom Kuznetsov, Jaro Reinders
date-accepted: ""
proposal-number: ""
ticket-url: ""
implemented: ""
...
There's an (old) merge request with `-Wpuns` warning implementation which can be found [here](https://gitlab.haskell.org/ghc/ghc/merge_requests/2044). This will be rebased or if that is too much work it will be used as inspiration. 
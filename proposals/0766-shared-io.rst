...
GHC will implement this by desugaring to `noinline <https://hackage-content.haskell.org/package/base-4.22.0.0/docs/GHC-Exts.html#v:noinline>`_:
...
::
    ...
    getFoo :: IO (IORef Int)
    getFoo = let !(Box a) = noinline getFoo_caf in pure a

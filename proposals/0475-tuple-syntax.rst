...
#. Export the following definitions from ``Data.Tuple.Experimental``::
     ...
     type family TupleArgKind n = r | r -> n where
       TupleArgKind 0 = Unit
       TupleArgKind 1 = Type       -- *not* Solo Type; see Point 9 in "Effects and Interactions"
     ...
     type family ConstraintsArgKind n = r | r -> n where
       ...
       ConstraintsArgKind 1 = Constraint       -- *not* CSolo Constraint; see Point 9 in "Effects and Interactions"

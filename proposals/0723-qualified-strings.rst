...
It is highly recommended that all types with ``IsString`` instances defined provide a module with the below definitions, to enable locally-scoped overloading over ``-XOverloadedStrings``:

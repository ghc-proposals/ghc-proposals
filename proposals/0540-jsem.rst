...
In practice, the core of the implementation is contained within a single module
implementing the protocol. This module implements acquisition and release of
tokens, with a local pool of tokens. This local pool avoids excessive
